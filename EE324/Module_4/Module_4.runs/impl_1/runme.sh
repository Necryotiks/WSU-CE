...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Module_4/Module_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_IP_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_IP_BD_wrapper.tcl -notrace
