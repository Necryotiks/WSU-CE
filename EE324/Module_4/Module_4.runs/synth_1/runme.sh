...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Module_4/Module_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_IP_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_IP_BD_wrapper.tcl
