...
# module references:
# DUTY_CYCLE, DUTY_CYCLE, DUTY_CYCLE, PWM_CLK_EN, PWM_CLK_EN, PWM_CLK_EN
...
proc create_root_design { parentCell } {
  ...
  # Create instance: PWM_CLK_EN_1, and set properties
  set block_name PWM_CLK_EN
  set block_cell_name PWM_CLK_EN_1
  if { [catch {set PWM_CLK_EN_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $PWM_CLK_EN_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: PWM_CLK_EN_2, and set properties
  set block_name PWM_CLK_EN
  set block_cell_name PWM_CLK_EN_2
  if { [catch {set PWM_CLK_EN_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $PWM_CLK_EN_2 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: RGB_PWM_0, and set properties
  set RGB_PWM_0 [ create_bd_cell -type ip -vlnv user.org:user:RGB_PWM:1.0 RGB_PWM_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins RGB_PWM_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net DUTY_CYCLE_0_o_OUT [get_bd_ports o_OUT_0] [get_bd_pins DUTY_CYCLE_0/o_OUT]
  connect_bd_net -net DUTY_CYCLE_1_o_OUT [get_bd_ports o_OUT_1] [get_bd_pins DUTY_CYCLE_1/o_OUT]
  connect_bd_net -net DUTY_CYCLE_2_o_OUT [get_bd_ports o_OUT_2] [get_bd_pins DUTY_CYCLE_2/o_OUT]
  connect_bd_net -net PWM_CLK_EN_0_o_CLK_EN [get_bd_pins DUTY_CYCLE_0/i_CEN] [get_bd_pins PWM_CLK_EN_0/o_CLK_EN]
  connect_bd_net -net PWM_CLK_EN_1_o_CLK_EN [get_bd_pins DUTY_CYCLE_1/i_CEN] [get_bd_pins PWM_CLK_EN_1/o_CLK_EN]
  connect_bd_net -net PWM_CLK_EN_2_o_CLK_EN [get_bd_pins DUTY_CYCLE_2/i_CEN] [get_bd_pins PWM_CLK_EN_2/o_CLK_EN]
  connect_bd_net -net RGB_PWM_0_o_DC_VAL_B [get_bd_pins DUTY_CYCLE_2/i_DC_VAL] [get_bd_pins RGB_PWM_0/o_DC_VAL_B]
  connect_bd_net -net RGB_PWM_0_o_DC_VAL_G [get_bd_pins DUTY_CYCLE_1/i_DC_VAL] [get_bd_pins RGB_PWM_0/o_DC_VAL_G]
  connect_bd_net -net RGB_PWM_0_o_DC_VAL_R [get_bd_pins DUTY_CYCLE_0/i_DC_VAL] [get_bd_pins RGB_PWM_0/o_DC_VAL_R]
  connect_bd_net -net RGB_PWM_0_o_EN [get_bd_pins RGB_PWM_0/o_EN] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net RGB_PWM_0_o_PFREQ_VAL_B [get_bd_pins PWM_CLK_EN_2/i_PWM_FREQ] [get_bd_pins RGB_PWM_0/o_PFREQ_VAL_B]
  connect_bd_net -net RGB_PWM_0_o_PFREQ_VAL_G [get_bd_pins PWM_CLK_EN_1/i_PWM_FREQ] [get_bd_pins RGB_PWM_0/o_PFREQ_VAL_G]
  connect_bd_net -net RGB_PWM_0_o_PFREQ_VAL_R [get_bd_pins PWM_CLK_EN_0/i_PWM_FREQ] [get_bd_pins RGB_PWM_0/o_PFREQ_VAL_R]
  connect_bd_net -net RGB_PWM_0_o_PSW_VAL_B [get_bd_pins DUTY_CYCLE_2/i_PULSE_WINDOW] [get_bd_pins RGB_PWM_0/o_PSW_VAL_B]
  connect_bd_net -net RGB_PWM_0_o_PSW_VAL_G [get_bd_pins DUTY_CYCLE_1/i_PULSE_WINDOW] [get_bd_pins RGB_PWM_0/o_PSW_VAL_G]
  connect_bd_net -net RGB_PWM_0_o_PSW_VAL_R [get_bd_pins DUTY_CYCLE_0/i_PULSE_WINDOW] [get_bd_pins RGB_PWM_0/o_PSW_VAL_R]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DUTY_CYCLE_0/i_CLK] [get_bd_pins DUTY_CYCLE_1/i_CLK] [get_bd_pins DUTY_CYCLE_2/i_CLK] [get_bd_pins PWM_CLK_EN_0/i_CLK] [get_bd_pins PWM_CLK_EN_1/i_CLK] [get_bd_pins PWM_CLK_EN_2/i_CLK] [get_bd_pins RGB_PWM_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins RGB_PWM_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x4BB04000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RGB_PWM_0/S00_AXI/S00_AXI_reg] SEG_RGB_PWM_0_S00_AXI_reg
