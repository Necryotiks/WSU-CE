...
################################################################
# This is a generated script based on design: PWM_IP_BD
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: PWM_DRIVER_1, and set properties
  set PWM_DRIVER_1 [ create_bd_cell -type ip -vlnv user.org:user:PWM_DRIVER:2.0 PWM_DRIVER_1 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins PWM_DRIVER_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net PWM_DRIVER_1_o_LED [get_bd_ports o_LED] [get_bd_pins PWM_DRIVER_1/o_LED]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PWM_DRIVER_1/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PWM_DRIVER_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x4BB03000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWM_DRIVER_1/S00_AXI/S00_AXI_reg] SEG_PWM_DRIVER_1_S00_AXI_reg
