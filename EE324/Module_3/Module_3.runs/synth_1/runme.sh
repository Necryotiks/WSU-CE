...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Module_3/Module_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_DEBUG_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_DEBUG_BD_wrapper.tcl
