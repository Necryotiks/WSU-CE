...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Module_3/Module_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_DEBUG_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_DEBUG_BD_wrapper.tcl -notrace
