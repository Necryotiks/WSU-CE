...
proc create_root_design { parentCell } {
  ...
  set o_RGB_0_0 [ create_bd_port -dir O -from 2 -to 0 o_RGB_0_0 ]
  set o_RGB_1_0 [ create_bd_port -dir O -from 2 -to 0 o_RGB_1_0 ]
  set o_RGB_2_0 [ create_bd_port -dir O -from 2 -to 0 o_RGB_2_0 ]
  set o_RGB_3_0 [ create_bd_port -dir O -from 2 -to 0 o_RGB_3_0 ]

  # Create instance: LED_CONTROLLER_0, and set properties
  set LED_CONTROLLER_0 [ create_bd_cell -type ip -vlnv user.org:user:LED_CONTROLLER:1.0 LED_CONTROLLER_0 ]

  # Create instance: RGB_CONTROLLER_0, and set properties
  set RGB_CONTROLLER_0 [ create_bd_cell -type ip -vlnv user.org:user:RGB_CONTROLLER:1.0 RGB_CONTROLLER_0 ]

  # Create instance: SW_BTN_INTERFACE_0, and set properties
  set SW_BTN_INTERFACE_0 [ create_bd_cell -type ip -vlnv user.org:user:SW_BTN_INTERFACE:1.0 SW_BTN_INTERFACE_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins SW_BTN_INTERFACE_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net LED_CONTROLLER_0_o_LED [get_bd_ports o_LED] [get_bd_pins LED_CONTROLLER_0/o_LED]
  connect_bd_net -net RGB_CONTROLLER_0_o_RGB_0 [get_bd_ports o_RGB_0_0] [get_bd_pins RGB_CONTROLLER_0/o_RGB_0]
  connect_bd_net -net RGB_CONTROLLER_0_o_RGB_1 [get_bd_ports o_RGB_1_0] [get_bd_pins RGB_CONTROLLER_0/o_RGB_1]
  connect_bd_net -net RGB_CONTROLLER_0_o_RGB_2 [get_bd_ports o_RGB_2_0] [get_bd_pins RGB_CONTROLLER_0/o_RGB_2]
  connect_bd_net -net RGB_CONTROLLER_0_o_RGB_3 [get_bd_ports o_RGB_3_0] [get_bd_pins RGB_CONTROLLER_0/o_RGB_3]
  connect_bd_net -net i_BTN_0_1 [get_bd_ports i_BTN_0] [get_bd_pins SW_BTN_INTERFACE_0/i_BTN]
  connect_bd_net -net i_SW_0_1 [get_bd_ports i_SW_0] [get_bd_pins SW_BTN_INTERFACE_0/i_SW]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LED_CONTROLLER_0/s00_axi_aclk] [get_bd_pins RGB_CONTROLLER_0/s00_axi_aclk] [get_bd_pins SW_BTN_INTERFACE_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins LED_CONTROLLER_0/s00_axi_aresetn] [get_bd_pins RGB_CONTROLLER_0/s00_axi_aresetn] [get_bd_pins SW_BTN_INTERFACE_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x4BB02000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SW_BTN_INTERFACE_0/S00_AXI/S00_AXI_reg] SEG_SW_BTN_INTERFACE_0_S00_AXI_reg
