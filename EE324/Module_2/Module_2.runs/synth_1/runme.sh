...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Module_2/Module_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_IP_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_IP_wrapper.tcl
