...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Module_2/Module_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_IP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_IP_wrapper.tcl -notrace
