...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/EE324/Module_2/Module_2.runs/system_myLED_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_myLED_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_myLED_0_0.tcl
