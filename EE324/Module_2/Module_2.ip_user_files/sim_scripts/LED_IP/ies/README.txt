...
#
# Generated by export_simulation on Mon Mar 04 16:35:19 -0800 2019
#
################################################################################
...
'-reset_run' switch to the './LED_IP.sh' script.
...
./LED_IP.sh -noclean_files

For more information on the script, please type './LED_IP.sh -help'.
