...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Self_Checking_Testbench/Self_Checking_Testbench.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_FIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_FIFO.tcl
