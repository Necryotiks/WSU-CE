...
vlog -work xil_defaultlib -64 -sv "+incdir+../../../../Module_5.srcs/sources_1/bd/HDMI_CONTROLLER_BD/ipshared/c923" \
"/opt/Vivado/2019.1/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \

vcom -work xpm -64 -93 \
"/opt/Vivado/2019.1/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work xil_defaultlib -64 "+incdir+../../../../Module_5.srcs/sources_1/bd/HDMI_CONTROLLER_BD/ipshared/c923" \
