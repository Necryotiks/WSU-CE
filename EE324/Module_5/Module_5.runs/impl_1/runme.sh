...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Module_5/Module_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_CONTROLLER_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_CONTROLLER_BD_wrapper.tcl -notrace
