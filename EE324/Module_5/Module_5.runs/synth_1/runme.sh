...
HD_PWD='/home/necryotiks/Documents/Repos/WSU-CPTE/EE324/Module_5/Module_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_CONTROLLER_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_CONTROLLER_BD_wrapper.tcl
