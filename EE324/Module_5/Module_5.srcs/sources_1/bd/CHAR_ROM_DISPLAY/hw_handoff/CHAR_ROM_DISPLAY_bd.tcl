...
################################################################
# This is a generated script based on design: CHAR_ROM_DISPLAY
#
...
# source CHAR_ROM_DISPLAY_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# ASCII_addr_gen, C_ROM_LOGIC, RAM_RANGLER_FSM, VGA_controller, char_rom
...
set design_name CHAR_ROM_DISPLAY
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ASCII_addr_gen_0, and set properties
  set block_name ASCII_addr_gen
  set block_cell_name ASCII_addr_gen_0
  if { [catch {set ASCII_addr_gen_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ASCII_addr_gen_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: CHAR_ROM_CONTROLLER_0, and set properties
  set CHAR_ROM_CONTROLLER_0 [ create_bd_cell -type ip -vlnv user.org:user:CHAR_ROM_CONTROLLER:1.0 CHAR_ROM_CONTROLLER_0 ]

  # Create instance: C_ROM_LOGIC_0, and set properties
  set block_name C_ROM_LOGIC
  set block_cell_name C_ROM_LOGIC_0
  if { [catch {set C_ROM_LOGIC_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $C_ROM_LOGIC_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: RAM_RANGLER_FSM_0, and set properties
  set block_name RAM_RANGLER_FSM
  set block_cell_name RAM_RANGLER_FSM_0
  if { [catch {set RAM_RANGLER_FSM_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $RAM_RANGLER_FSM_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_ASCII_VAL [get_bd_pins ASCII_addr_gen_0/i_ASCII_VAL] [get_bd_pins RAM_RANGLER_FSM_0/o_ASCII_VAL]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_BG_BLUE [get_bd_pins CHAR_ROM_CONTROLLER_0/o_BG_BLUE] [get_bd_pins C_ROM_LOGIC_0/i_BG_BLUE]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_BG_GREEN [get_bd_pins CHAR_ROM_CONTROLLER_0/o_BG_GREEN] [get_bd_pins C_ROM_LOGIC_0/i_BG_GREEN]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_BG_RED [get_bd_pins CHAR_ROM_CONTROLLER_0/o_BG_RED] [get_bd_pins C_ROM_LOGIC_0/i_BG_RED]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_DATA_PACKET [get_bd_pins CHAR_ROM_CONTROLLER_0/o_DATA_PACKET] [get_bd_pins RAM_RANGLER_FSM_0/i_DATA]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_FG_BLUE [get_bd_pins C_ROM_LOGIC_0/i_FG_BLUE] [get_bd_pins RAM_RANGLER_FSM_0/o_FG_BLUE]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_FG_GREEN [get_bd_pins C_ROM_LOGIC_0/i_FG_GREEN] [get_bd_pins RAM_RANGLER_FSM_0/o_FG_GREEN]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_FG_RED [get_bd_pins C_ROM_LOGIC_0/i_FG_RED] [get_bd_pins RAM_RANGLER_FSM_0/o_FG_RED]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_START_X_COORD [get_bd_pins CHAR_ROM_CONTROLLER_0/o_START_X_COORD]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_START_Y_COORD [get_bd_pins CHAR_ROM_CONTROLLER_0/o_START_Y_COORD]
  connect_bd_net -net CHAR_ROM_CONTROLLER_0_o_WRITE_REQUEST [get_bd_pins CHAR_ROM_CONTROLLER_0/o_WRITE_REQUEST] [get_bd_pins RAM_RANGLER_FSM_0/i_WRITE_REQUEST]
  connect_bd_net -net C_ROM_LOGIC_0_o_BLUE [get_bd_pins C_ROM_LOGIC_0/o_BLUE] [get_bd_pins hdmi_tx_0/blue]
  ...
  connect_bd_net -net VGA_controller_0_o_VDE [get_bd_pins C_ROM_LOGIC_0/i_VDE] [get_bd_pins RAM_RANGLER_FSM_0/i_VDE] [get_bd_pins VGA_controller_0/o_VDE] [get_bd_pins hdmi_tx_0/vde]
  connect_bd_net -net VGA_controller_0_o_VSYNC [get_bd_pins VGA_controller_0/o_VSYNC] [get_bd_pins hdmi_tx_0/vsync]
  connect_bd_net -net char_rom_0_DO [get_bd_pins C_ROM_LOGIC_0/i_CHAR_LINE] [get_bd_pins char_rom_0/o_DATA]
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins char_rom_0/RST] [get_bd_pins hdmi_tx_0/rst] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins char_rom_0/WE] [get_bd_pins xlconstant_4/dout]
