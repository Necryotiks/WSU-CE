...
#
# Generated by export_simulation on Tue Feb 26 00:01:53 -0800 2019
#
################################################################################
...
'-reset_run' switch to the './Bounce_Timer.sh' script.

./Bounce_Timer.sh -reset_run
...
./Bounce_Timer.sh -noclean_files

For more information on the script, please type './Bounce_Timer.sh -help'.
