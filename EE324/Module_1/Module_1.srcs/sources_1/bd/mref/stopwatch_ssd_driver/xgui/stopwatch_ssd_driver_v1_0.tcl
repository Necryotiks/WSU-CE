...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DISPLAY_MODE" -parent ${Page_0}
...
proc update_MODELPARAM_VALUE.DISPLAY_MODE { MODELPARAM_VALUE.DISPLAY_MODE PARAM_VALUE.DISPLAY_MODE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DISPLAY_MODE}] ${MODELPARAM_VALUE.DISPLAY_MODE}
}
