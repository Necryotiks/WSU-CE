...
################################################################
# This is a generated script based on design: YEET
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: o_BLUE, and set properties
  set o_BLUE [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 o_BLUE ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {3} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {8} \
  ...
  # Create instance: o_GREEN, and set properties
  set o_GREEN [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 o_GREEN ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {3} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {8} \
  ...
  # Create instance: o_RED, and set properties
  set o_RED [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 o_RED ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {3} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {8} \
  ...
  connect_bd_net -net clk_100MHz_1 [get_bd_ports i_CLK] [get_bd_pins clk_wiz_1/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins VGA_controller_0/i_CLK] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins color_logic_0/i_CLK] [get_bd_pins hdmi_tx_0/pix_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins hdmi_tx_0/pix_clkx5]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins hdmi_tx_0/pix_clk_locked]
  connect_bd_net -net color_logic_0_o_BLUE [get_bd_pins color_logic_0/o_BLUE] [get_bd_pins hdmi_tx_0/blue] [get_bd_pins o_BLUE/Din]
  connect_bd_net -net color_logic_0_o_GREEN [get_bd_pins color_logic_0/o_GREEN] [get_bd_pins hdmi_tx_0/green] [get_bd_pins o_GREEN/Din]
  connect_bd_net -net color_logic_0_o_RED [get_bd_pins color_logic_0/o_RED] [get_bd_pins hdmi_tx_0/red] [get_bd_pins o_RED/Din]
  connect_bd_net -net o_BLUE_Dout [get_bd_ports o_BLUE] [get_bd_pins o_BLUE/Dout]
  connect_bd_net -net o_GREEN_Dout [get_bd_ports o_GREEN] [get_bd_pins o_GREEN/Dout]
  connect_bd_net -net o_RED_Dout [get_bd_ports o_RED] [get_bd_pins o_RED/Dout]
  ...
  connect_bd_net -net reset_rtl_0_1 [get_bd_ports i_RST] [get_bd_pins clk_wiz_1/reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
