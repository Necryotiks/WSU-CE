...
HD_PWD='C:/Users/Sergaljerk/Project4.3/Project4.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ssdwrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ssdwrapper.tcl -notrace
