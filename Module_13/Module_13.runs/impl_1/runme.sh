...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_13/Module_13.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_CTRL_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_CTRL_wrapper.tcl -notrace
