...
module HDMI_VGA
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.I_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.I_CLK, CLK_DOMAIN HDMI_VGA_clk_100MHz, FREQ_HZ 100000000, PHASE 0.000" *) input i_CLK;
  ...
  HDMI_VGA_xlslice_0_0 xlslice_0
       (.Din(color_logic_0_o_RED),
        .Dout(xlslice_0_Dout));
  HDMI_VGA_xlslice_1_0 xlslice_1
       (.Din(color_logic_0_o_GREEN),
        .Dout(xlslice_1_Dout));
  HDMI_VGA_xlslice_2_0 xlslice_2
