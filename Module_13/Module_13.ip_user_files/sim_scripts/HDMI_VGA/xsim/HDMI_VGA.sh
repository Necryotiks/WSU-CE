...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlslice_v1_0_1 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot HDMI_VGA xil_defaultlib.HDMI_VGA xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim HDMI_VGA -key {Behavioral:sim_1:Functional:HDMI_VGA} -tclbatch cmd.tcl -log simulate.log
}
