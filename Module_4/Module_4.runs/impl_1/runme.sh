...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_4/Module_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source challenge_4.tcl -notrace
