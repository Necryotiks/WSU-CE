...
HD_PWD='C:/Users/lauer/WSU-CPTE/Project5.4_VHDL/Project5.4_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ck_wrapper_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ck_wrapper_vhdl.tcl -notrace
