...
HD_PWD='C:/Users/lauer/WSU-CPTE/Project5.4_VHDL/Project5.4_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ck_wrapper_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ck_wrapper_vhdl.tcl
