...
HD_PWD='C:/Users/Sergaljerk/Project5.3/Project5.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clkdiv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clkdiv.tcl -notrace
