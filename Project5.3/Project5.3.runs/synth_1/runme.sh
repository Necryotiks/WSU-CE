...
HD_PWD='C:/Users/Sergaljerk/Project5.3/Project5.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkdiv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkdiv.tcl
