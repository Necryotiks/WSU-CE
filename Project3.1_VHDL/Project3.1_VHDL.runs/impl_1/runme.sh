...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Project3.1_VHDL/Project3.1_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log majority_of_five_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source majority_of_five_vhdl.tcl -notrace
