...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Project3.1_VHDL/Project3.1_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log majority_of_five_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source majority_of_five_vhdl.tcl
