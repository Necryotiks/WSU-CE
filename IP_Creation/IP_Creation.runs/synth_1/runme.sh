...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/IP_Creation/IP_Creation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SVD_DRIVER_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SVD_DRIVER_BD_wrapper.tcl
