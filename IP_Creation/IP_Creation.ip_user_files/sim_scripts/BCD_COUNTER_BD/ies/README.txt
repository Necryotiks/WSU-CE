...
#
# Generated by export_simulation on Sat Mar 02 01:21:01 -0800 2019
#
################################################################################
...
'-reset_run' switch to the './BCD_COUNTER_BD.sh' script.

./BCD_COUNTER_BD.sh -reset_run
...
./BCD_COUNTER_BD.sh -noclean_files

For more information on the script, please type './BCD_COUNTER_BD.sh -help'.
