...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_2/Module_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source challenge_2.tcl -notrace
