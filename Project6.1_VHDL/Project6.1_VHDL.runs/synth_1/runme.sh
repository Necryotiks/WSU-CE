...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Project6.1_VHDL/Project6.1_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arith_vhdl_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arith_vhdl_tb.tcl
