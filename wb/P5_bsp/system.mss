...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = H_Bridge
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = H_Bridge
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = RGB_LED
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = RGB_LED
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SEVEN_SEG_DISP
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SEVEN_SEG_DISP
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SWITCHES_BUTTONS
 PARAMETER DRIVER_VER = 1.0
