...
HD_PWD='C:/Users/lauer/Desktop/EE214/Project2.2/Project2.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsw_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsw_led.tcl
