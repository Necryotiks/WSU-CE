...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_7/Module_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PIPO_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PIPO_wrapper.tcl -notrace
