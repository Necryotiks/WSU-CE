...
################################################################
# This is a generated script based on design: FSM
#
...
# source FSM_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# HZ_Counter, stopwatchFSM
...
proc create_root_design { parentCell } {
  ...
  set o_ENABLE_0 [ create_bd_port -dir O o_ENABLE_0 ]
  ...
  connect_bd_net -net clk_100MHz_1 [get_bd_ports i_CLK] [get_bd_pins HZ_Counter_0/i_CLK] [get_bd_pins rst_clk_100MHz_100M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_rtl_0_1 [get_bd_ports i_RST] [get_bd_pins rst_clk_100MHz_100M/ext_reset_in]
  connect_bd_net -net rst_clk_100MHz_100M_peripheral_aresetn [get_bd_pins HZ_Counter_0/i_RST] [get_bd_pins rst_clk_100MHz_100M/peripheral_aresetn] [get_bd_pins stopwatchFSM_0/i_RST]
  connect_bd_net -net stopwatchFSM_0_o_ENABLE [get_bd_ports o_ENABLE_0] [get_bd_pins stopwatchFSM_0/o_ENABLE]
