...
module STOPWATCH
   (i_CLK,
    ...
    o_Anodes_0,
    o_Cathodes_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.I_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.I_CLK, CLK_DOMAIN STOPWATCH_i_CLK, FREQ_HZ 100000000, PHASE 0.000" *) input i_CLK;
  input i_Inc_0;
  ...
  wire [3:0]SW_T_MUX_0_o_Digit_1;
  wire [3:0]SW_T_MUX_0_o_Digit_2;
  wire [3:0]SW_T_MUX_0_o_Digit_3;
  wire [3:0]SW_T_MUX_0_o_Digit_4;
  wire clk_100MHz_1;
  wire i_Inc_0_1;
  wire i_RST_0_1;
  wire i_Start_0_1;
  ...
  STOPWATCH_SW_T_MUX_0_0 SW_T_MUX_0
       (.i_CLK(clk_100MHz_1),
        ...
        .i_Sel(i_TIMER_0_1),
        .i_T_Digit_1(timer_ssd_driver_0_o_Digit_1_val),
        .i_T_Digit_2(timer_ssd_driver_0_o_Digit_2_val),
        .i_T_Digit_3(timer_ssd_driver_0_o_Digit_3_val),
        .i_T_Digit_4(timer_ssd_driver_0_o_Digit_4_val),
        .o_Digit_1(SW_T_MUX_0_o_Digit_1),
        .o_Digit_2(SW_T_MUX_0_o_Digit_2),
        .o_Digit_3(SW_T_MUX_0_o_Digit_3),
        .o_Digit_4(SW_T_MUX_0_o_Digit_4));
  ...
  STOPWATCH_ssd_mux_0_0 ssd_mux_0
       (.i_CLK(clk_100MHz_1),
        .i_Digit_1(SW_T_MUX_0_o_Digit_1),
        .i_Digit_2(SW_T_MUX_0_o_Digit_2),
        .i_Digit_3(SW_T_MUX_0_o_Digit_3),
        .i_Digit_4(SW_T_MUX_0_o_Digit_4),
  ...
  STOPWATCH_timer_ssd_driver_0_0 timer_ssd_driver_0
       (.i_RST(rst_clk_100MHz_100M_peripheral_aresetn),
        .i_SUBCLK(stopwatchFSM_0_o_ENABLE),
