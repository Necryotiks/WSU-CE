...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_11/Module_11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log STOPWATCH_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source STOPWATCH_wrapper.tcl
