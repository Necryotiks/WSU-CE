...
#
# Generated by export_simulation on Mon Nov 12 00:19:02 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './S_A_FSM.sh' script.

./S_A_FSM.sh -reset_run
...
./S_A_FSM.sh -noclean_files

For more information on the script, please type './S_A_FSM.sh -help'.
