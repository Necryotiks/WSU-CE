...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_10/Module_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARITHMETIC_LOGIC_UNIT_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ARITHMETIC_LOGIC_UNIT_wrapper.tcl
