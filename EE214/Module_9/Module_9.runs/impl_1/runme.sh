...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_9/Module_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S_ADDER_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S_ADDER_wrapper.tcl -notrace
