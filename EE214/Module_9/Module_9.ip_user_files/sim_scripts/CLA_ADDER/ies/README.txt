...
#
# Generated by export_simulation on Fri Oct 26 21:03:53 -0700 2018
#
################################################################################
...
'-reset_run' switch to the './CLA_ADDER.sh' script.

./CLA_ADDER.sh -reset_run
...
./CLA_ADDER.sh -noclean_files

For more information on the script, please type './CLA_ADDER.sh -help'.
