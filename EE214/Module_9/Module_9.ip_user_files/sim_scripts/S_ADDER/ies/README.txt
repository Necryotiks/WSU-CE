...
#
# Generated by export_simulation on Mon Oct 29 16:01:08 -0700 2018
#
################################################################################
...
'-reset_run' switch to the './S_ADDER.sh' script.

./S_ADDER.sh -reset_run
...
./S_ADDER.sh -noclean_files

For more information on the script, please type './S_ADDER.sh -help'.
