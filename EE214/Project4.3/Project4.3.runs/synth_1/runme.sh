...
HD_PWD='C:/Users/Sergaljerk/Project4.3/Project4.3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ssdwrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ssdwrapper.tcl
