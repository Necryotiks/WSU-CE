...
HD_PWD='C:/Users/Necryotiks/AppData/Roaming/SPB_Data/WSU-CPTE/Module_12/Module_12.runs/Reaction_Time_Averager_Divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reaction_Time_Averager_Divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reaction_Time_Averager_Divider_0_0.tcl
