...
HD_PWD='C:/Users/Necryotiks/AppData/Roaming/SPB_Data/WSU-CPTE/Module_12/Module_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reaction_Time_Averager_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reaction_Time_Averager_wrapper.tcl
