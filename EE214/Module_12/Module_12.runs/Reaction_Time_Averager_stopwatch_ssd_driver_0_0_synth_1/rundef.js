...
ISEStep( "vivado",
         "-log Reaction_Time_Averager_stopwatch_ssd_driver_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reaction_Time_Averager_stopwatch_ssd_driver_0_0.tcl" );
