...
ISEStep( "vivado",
         "-log Reaction_Time_Averager_BINARY_TO_BCD_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reaction_Time_Averager_BINARY_TO_BCD_0_0.tcl" );
