...
ISEStep( "vivado",
         "-log Reaction_Time_Averager_BCD_TO_BINARY_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reaction_Time_Averager_BCD_TO_BINARY_0_0.tcl" );
