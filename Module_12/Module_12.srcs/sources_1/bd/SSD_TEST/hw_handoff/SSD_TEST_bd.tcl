...
################################################################
# This is a generated script based on design: SSD_TEST
#
...
# source SSD_TEST_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# HZ_Counter, LSFR, RTM_FSM, stopwatch_ssd_driver
...
proc create_root_design { parentCell } {
  ...
  set o_Digit_1_val_0 [ create_bd_port -dir O -from 3 -to 0 o_Digit_1_val_0 ]
  set o_Digit_2_val_0 [ create_bd_port -dir O -from 3 -to 0 o_Digit_2_val_0 ]
  set o_Digit_3_val_0 [ create_bd_port -dir O -from 3 -to 0 o_Digit_3_val_0 ]
  set o_Digit_4_val_0 [ create_bd_port -dir O -from 3 -to 0 o_Digit_4_val_0 ]
  ...
  connect_bd_net -net i_CLK_1 [get_bd_ports i_CLK] [get_bd_pins HZ_Counter_0/i_CLK] [get_bd_pins LSFR_0/i_CLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins HZ_Counter_0/i_RST] [get_bd_pins LSFR_0/i_RST] [get_bd_pins RTM_FSM_0/i_RST] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins stopwatch_ssd_driver_0/i_RST]
  connect_bd_net -net stopwatch_ssd_driver_0_o_Digit_1_val [get_bd_ports o_Digit_1_val_0] [get_bd_pins stopwatch_ssd_driver_0/o_Digit_1_val]
  connect_bd_net -net stopwatch_ssd_driver_0_o_Digit_2_val [get_bd_ports o_Digit_2_val_0] [get_bd_pins stopwatch_ssd_driver_0/o_Digit_2_val]
  connect_bd_net -net stopwatch_ssd_driver_0_o_Digit_3_val [get_bd_ports o_Digit_3_val_0] [get_bd_pins stopwatch_ssd_driver_0/o_Digit_3_val]
  connect_bd_net -net stopwatch_ssd_driver_0_o_Digit_4_val [get_bd_ports o_Digit_4_val_0] [get_bd_pins stopwatch_ssd_driver_0/o_Digit_4_val]
