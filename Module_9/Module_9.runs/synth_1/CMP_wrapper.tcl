...
set_property used_in_implementation false [get_files -all C:/Users/Sergaljerk/WSU-CPTE/Module_9/Module_9.srcs/sources_1/bd/CMP/CMP_ooc.xdc]
...
set_property used_in_implementation false [get_files C:/Users/Sergaljerk/WSU-CPTE/Module_9/Module_9.srcs/constrs_1/new/CMP_wrapper_cons.xdc]
...
synth_design -top CMP_wrapper -part xc7z007sclg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef CMP_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file CMP_wrapper_utilization_synth.rpt -pb CMP_wrapper_utilization_synth.pb"
