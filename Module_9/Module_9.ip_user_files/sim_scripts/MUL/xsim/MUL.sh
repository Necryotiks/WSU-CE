...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xlslice_v1_0_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MUL xil_defaultlib.MUL xil_defaultlib.glbl -log elaborate.log
}
