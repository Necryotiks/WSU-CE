...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_1/Module_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SW_backwards.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SW_backwards.tcl -notrace
