...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Project3.2_VHDL/Project3.2_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source temp_vhdl.tcl -notrace
