...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Project3.2_VHDL/Project3.2_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temp_vhdl.tcl
