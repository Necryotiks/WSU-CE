...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Project6.1/Project6.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cmp.tcl
