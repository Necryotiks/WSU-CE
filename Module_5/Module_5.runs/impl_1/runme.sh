...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_5/Module_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source challenge_5.tcl -notrace
