...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_3/Module_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source challenge_3.tcl -notrace
