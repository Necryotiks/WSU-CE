...
#
# Generated by export_simulation on Fri Nov 09 01:04:31 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './STOPWATCH.sh' script.

./STOPWATCH.sh -reset_run
...
./STOPWATCH.sh -noclean_files

For more information on the script, please type './STOPWATCH.sh -help'.
