...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_11/Module_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log STOPWATCH_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source STOPWATCH_wrapper.tcl -notrace
