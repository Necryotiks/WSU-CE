...
HD_PWD='C:/Users/lauer/WSU-CPTE/Project5.3_VHDL/Project5.3_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkdiv_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkdiv_vhdl.tcl
