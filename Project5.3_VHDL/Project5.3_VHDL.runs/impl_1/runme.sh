...
HD_PWD='C:/Users/lauer/WSU-CPTE/Project5.3_VHDL/Project5.3_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clkdiv_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clkdiv_vhdl.tcl -notrace
