...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_10/Module_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ARITHMETIC_LOGIC_UNIT_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ARITHMETIC_LOGIC_UNIT_wrapper.tcl -notrace
