...
################################################################
# This is a generated script based on design: ARITHMETIC_LOGIC_UNIT
#
...
# source ARITHMETIC_LOGIC_UNIT_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# ALU, PIPO, PIPO, ssd_dec, ssd_mux
...
set design_name ARITHMETIC_LOGIC_UNIT
...
proc create_root_design { parentCell } {
  ...
  set o_Status [ create_bd_port -dir O -from 3 -to 0 o_Status ]
  ...
  # Create instance: Selector, and set properties
  set Selector [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 Selector ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {2} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {8} \
  ...
  connect_bd_net -net i_BTN_1_1 [get_bd_ports i_LD_1] [get_bd_pins PIPO_1/i_BTN]
  connect_bd_net -net i_SW_0_1 [get_bd_ports i_SW] [get_bd_pins PIPO_0/i_SW] [get_bd_pins PIPO_1/i_SW] [get_bd_pins Selector/Din]
  connect_bd_net -net ssd_dec_0_o_Cathodes [get_bd_ports o_Cathodes] [get_bd_pins ssd_dec_0/o_Cathodes]
