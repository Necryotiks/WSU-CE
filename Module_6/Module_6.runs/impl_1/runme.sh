...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_6/Module_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source challenge_6.tcl -notrace
