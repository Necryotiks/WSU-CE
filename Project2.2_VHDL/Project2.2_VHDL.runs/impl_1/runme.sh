...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Project2.2_VHDL/Project2.2_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsw_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsw_vhdl.tcl -notrace
