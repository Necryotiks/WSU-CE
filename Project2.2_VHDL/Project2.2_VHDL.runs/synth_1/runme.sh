...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Project2.2_VHDL/Project2.2_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsw_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsw_vhdl.tcl
