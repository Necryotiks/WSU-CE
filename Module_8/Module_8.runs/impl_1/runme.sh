...
HD_PWD='C:/Users/Sergaljerk/WSU-CPTE/Module_8/Module_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log challenge_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source challenge_8.tcl -notrace
